...
@section('page-content')
	<div class="container-fluid">
        <div class="row justify-content-center" id="vinesh">
            ...
            @endphp
                <div class="col-lg-3 col-md-6 col-sm-12 col-12 mb-4" >
                    ...
                    <center>                         
                        <div onclick="screenshot('{{$ibox}}')" class="btn btn-primary btn-lg mygeneratedButton" id="{{$ibox}}">Download</div>
             ...
             var base64URL = canvas.toDataURL('image/jpeg').replace('image/jpeg', 'image/octet-stream');
                   ...
                   jQuery.ajax({
                      ...
                      success: function(result){
                         console.log(result);
                         var htmldata = '<img  src="{{ asset("uploads") }}/'+result+' ">';  
                         var htmldata = '<img  src="{{ asset("uploads") }}/'+result+' ">';  
